...
func (m *ConfigManager) EditFeatures(entityLabel, fgLabel string, featureLabels, defaultValues, storageProvider, sourceBasePath, sourceDataPath, stringLength, vectorLength []string) ([]string, ofsConfig.Store, error) {
	return nil, ofsConfig.Store{}, nil
}
