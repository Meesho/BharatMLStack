...
import (
	...
	orionConfig "github.com/Meesho/BharatMLStack/horizon/internal/online-feature-store/config"
...
func TestDeleteFeatures(t *testing.T) {
	tests := []struct {
		...
		mockFeatureGroup    *orionConfig.FeatureGroup
	...
	}{
		{
			...
			mockFeatureGroup: &orionConfig.FeatureGroup{
				ActiveVersion: "1",
				Features: map[string]orionConfig.Feature{
					"1": {
						Labels:      "feature1,feature2",
						FeatureMeta: map[string]orionConfig.FeatureMeta{"feature1": {}, "feature2": {}},
					},
				},
			},
	...
	tests := []struct {
		...
		},
		{
			...
			mockFeatureGroup: &orionConfig.FeatureGroup{
				ActiveVersion: "1",
				Features: map[string]orionConfig.Feature{
					"1": {FeatureMeta: map[string]orionConfig.FeatureMeta{"feature1": {}}},
				},
			},
			mockFeatureGroupErr: nil,
