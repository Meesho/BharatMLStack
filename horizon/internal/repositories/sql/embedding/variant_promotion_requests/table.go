...
const VariantPromotionRequestsTableName = "variant_promotion_requests"
...
func (VariantPromotionRequest) TableName() string {
	return VariantPromotionRequestsTableName
}

func (VariantPromotionRequest) BeforeCreate(tx *gorm.DB) (err error) {
	tx.Statement.SetColumn(constant.CreatedAt, time.Now())
	return
}

func (VariantPromotionRequest) BeforeUpdate(tx *gorm.DB) (err error) {
