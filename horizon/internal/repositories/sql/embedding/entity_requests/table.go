...
const EntityRequestsTableName = "entity_requests"
...
func (EntityRequest) TableName() string {
	return EntityRequestsTableName
}

func (EntityRequest) BeforeCreate(tx *gorm.DB) (err error) {
	tx.Statement.SetColumn(constant.CreatedAt, time.Now())
	return
}

func (EntityRequest) BeforeUpdate(tx *gorm.DB) (err error) {
