...
client:
  onfs-grpc:
    ...
    auth-token: ${ONLINE_FEATURE_STORE_AUTH_TOKEN:dummy}
```
...
import com.bharatml.client.dtos.FeatureGroup;
import com.bharatml.client.dtos.Keys;
import com.bharatml.client.dtos.Query;
import com.bharatml.client.services.impls.OnfsService;
import com.bharatml.client.grpc.config.OnfsClientConfig;
import static com.bharatml.client.Constants.ONFS_GRPC_PROPERTIES;
import static com.bharatml.client.Constants.ONFS_AUTH_TOKEN;
import static com.bharatml.client.Constants.ONFS_CALLER_ID;
