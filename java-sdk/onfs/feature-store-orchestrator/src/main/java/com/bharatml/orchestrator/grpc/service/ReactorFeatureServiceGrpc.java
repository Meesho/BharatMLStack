...
import static com.bharatml.orchestrator.grpc.service.FeatureServiceGrpc.getServiceDescriptor;
...
public final class ReactorFeatureServiceGrpc {
    ...
    public static final class ReactorFeatureServiceStub extends io.grpc.stub.AbstractStub<ReactorFeatureServiceStub> {
        ...
        public reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.Result> retrieveFeatures(reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.Query> reactorRequest) {
            return com.salesforce.reactorgrpc.stub.ClientCalls.oneToOne(reactorRequest, delegateStub::retrieveFeatures, getCallOptions());
        }

        public reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.DecodedResult> retrieveDecodedResult(reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.Query> reactorRequest) {
        ...
        public reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.Result> retrieveFeatures(com.bharatml.orchestrator.grpc.service.RetrieveProto.Query reactorRequest) {
        ...
        public reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.DecodedResult> retrieveDecodedResult(com.bharatml.orchestrator.grpc.service.RetrieveProto.Query reactorRequest) {
    ...
    public static abstract class FeatureServiceImplBase implements io.grpc.BindableService {
        ...
        public reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.Result> retrieveFeatures(com.bharatml.orchestrator.grpc.service.RetrieveProto.Query request) {
            return retrieveFeatures(reactor.core.publisher.Mono.just(request));
        }

        public reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.Result> retrieveFeatures(reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.Query> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }

        public reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.DecodedResult> retrieveDecodedResult(com.bharatml.orchestrator.grpc.service.RetrieveProto.Query request) {
            return retrieveDecodedResult(reactor.core.publisher.Mono.just(request));
        }

        public reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.DecodedResult> retrieveDecodedResult(reactor.core.publisher.Mono<com.bharatml.orchestrator.grpc.service.RetrieveProto.Query> request) {
            throw new io.grpc.StatusRuntimeException(io.grpc.Status.UNIMPLEMENTED);
        }
        ...
        @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
            return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                    .addMethod(
                            com.bharatml.orchestrator.grpc.service.FeatureServiceGrpc.getRetrieveFeaturesMethod(),
                            asyncUnaryCall(
                                    new MethodHandlers<
                    ...
                    .addMethod(
                            com.bharatml.orchestrator.grpc.service.FeatureServiceGrpc.getRetrieveDecodedResultMethod(),
                            asyncUnaryCall(
                                    new MethodHandlers<
                                            com.bharatml.orchestrator.grpc.service.RetrieveProto.Query,
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_RETRIEVE_FEATURES:
                    com.salesforce.reactorgrpc.stub.ServerCalls.oneToOne((com.bharatml.orchestrator.grpc.service.RetrieveProto.Query) request,
