...
const FeatureGroupDiscovery = ({ entityId, onFeatureGroupClick }) => {
  ...
  const fetchFeatureGroups = useCallback(() => {
    if (entityId) {
      ...
      axios
        .get(`${URL_CONSTANTS.REACT_APP_HORIZON_BASE_URL}/api/v1/orion/retrieve-feature-groups?entity=${entityId}`, {
          headers: {
  ...
  const handleEditSubmit = () => {
    ...
    axios
      .post(`${URL_CONSTANTS.REACT_APP_HORIZON_BASE_URL}/api/v1/orion/edit-feature-group`, payload, {
        headers: {
          Authorization: `Bearer ${token}`,
