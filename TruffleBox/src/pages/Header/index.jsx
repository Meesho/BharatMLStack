    ...
    // Parent: Feature Store/Orion
    {
      ...
      children: [
        // Feature Store Discovery
        {
          ...
          label: 'Discovery',
          subItems: [
            { key: 'FeatureDiscovery', label: 'Feature Discovery', path: '/feature-discovery' },
            { key: 'StoreDiscovery', label: 'Store Discovery', path: '/store-discovery' },
            { key: 'JobDiscovery', label: 'Job Discovery', path: '/job-discovery' },
          ],
        ...
        // Feature Registry
        {
          ...
          label: 'Registry',
          subItems: [
            { key: 'StoreRegistry', label: 'Store Registry', path: '/feature-registry/store' },
            { key: 'JobRegistry', label: 'Job Registry', path: '/feature-registry/job' },
            { key: 'EntityRegistry', label: 'Entity Registry', path: '/feature-registry/entity' },
            { key: 'FeatureGroupRegistry', label: 'Feature Group Registry', path: '/feature-registry/feature-group' },
            { key: 'FeatureAddition', label: 'Feature Addition', path: '/feature-registry/feature' },
          ],
          roles: ['user', 'admin'],
        },
        // Feature Approval
