...
mod tests {
    ...
    use crate::handler::handler::{
        ...
        ByteList,
        EntityScoreData,
        proto::numerix_server::Numerix,
        proto::numerix_response_proto,
    ...
    async fn test_valid_compute_request() {
        ...
        let response_check = NumerixResponseProto {
            response: Some(numerix_response_proto::Response::ComputationScoreData(ComputationScoreData {
    ...
    async fn test_invalid_compute_id() {
        ...
        match response_inner.response {
            ...
            _ => panic!("Expected error response for invalid compute_id, got: {:?}", response_inner),
        }
    }
    ...
    async fn test_missing_entity_score_data() {
        ...
        match response_inner.response {
            ...
            _ => panic!("Expected error response for missing entity_score_data, got: {:?}", response_inner),
        }
    }
    ...
    async fn test_empty_schema() {
        ...
        match response_inner.response {
            ...
            _ => panic!("Expected error response for empty schema, got: {:?}", response_inner),
        }
    }
    ...
    async fn test_empty_entity_scores() {
        ...
        match response_inner.response {
            ...
            _ => panic!("Expected error response for empty entity_scores, got: {:?}", response_inner),
        }
    }
    ...
    async fn test_empty_compute_id() {
        ...
        match response_inner.response {
            ...
            _ => panic!("Expected error response for empty compute_id, got: {:?}", response_inner),
        }
    }
    ...
    async fn test_invalid_string_data_format() {
        ...
        match response_inner.response {
            ...
            _ => panic!("Expected computation data with default values, got: {:?}", response_inner),
        }
    }
    ...
    async fn test_larger_dataset() {
        ...
        match &response_inner.response {
            Some(numerix_response_proto::Response::ComputationScoreData(data)) => {
                assert_eq!(data.computation_scores.len(), 10, "Expected 10 computation results");
            },
    ...
    async fn test_matrix_format_none() {
        ...
        match response_inner.response {
            ...
            _ => panic!("Expected either error or computation data with defaults, got: {:?}", response_inner),
        }
    }
    ...
    async fn test_mixed_data_types() {
        ...
        match response_inner.response {
            ...
            _ => panic!("Expected either error or computation data, got: {:?}", response_inner),
        }
    }
}