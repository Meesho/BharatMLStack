...
const (
	...
	PersistMetadataQuery  = "insert into %s.%s (%s) values (%s)"
...
type Database interface {
	...
	PersistMetadata(metadataTableName string, userId string, columns map[string]interface{}) error
	UpdateMetadata(metadataTableName string, userId string, column string, value interface{}) error
}
