...
func (m *MockConfigManager) GetAllRegisteredClients() map[string]string {
	args := m.Called()
...
func (m *MockConfigManager) GetLayoutShadowComparisonConfig() LayoutShadowComparisonConfig {
	return LayoutShadowComparisonConfig{}
}
