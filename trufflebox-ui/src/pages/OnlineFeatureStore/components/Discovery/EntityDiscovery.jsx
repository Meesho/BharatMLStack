...
function EntityDiscovery({ onEntityClick }) {
    ...
    const fetchEntities = useCallback(() => {
        ...
        axios
            .get(`${URL_CONSTANTS.REACT_APP_HORIZON_BASE_URL}/api/v1/online-feature-store/retrieve-entities`, {
                headers: {
    ...
    const handleEditSubmit = () => {
        ...
        axios
            .post(`${URL_CONSTANTS.REACT_APP_HORIZON_BASE_URL}/api/v1/online-feature-store/edit-entity`, payload, {
                headers: {
                    Authorization: `Bearer ${token}`,
