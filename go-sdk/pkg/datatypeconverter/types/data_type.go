...
func ParseDataType(value string) (DataType, error) {
	...
	case "DataTypeFP8E5M2":
		return DataTypeFP8E5M2, nil
	case "DataTypeFP8E4M3":
		return DataTypeFP8E4M3, nil
	case "DataTypeFP16":
		return DataTypeFP16, nil
	case "DataTypeFP32":
		return DataTypeFP32, nil
	case "DataTypeFP64":
		return DataTypeFP64, nil
	case "DataTypeInt8":
	...
	case "DataTypeFP8E5M2Vector":
		return DataTypeFP8E5M2Vector, nil
	case "DataTypeFP8E4M3Vector":
		return DataTypeFP8E4M3Vector, nil
	case "DataTypeFP16Vector":
		return DataTypeFP16Vector, nil
	...
	case "DataTypeInt8Vector":
		return DataTypeInt8Vector, nil
	case "DataTypeInt16Vector":
		return DataTypeInt16Vector, nil
	...
	case "DataTypeUint8Vector":
		return DataTypeUint8Vector, nil
	case "DataTypeUint16Vector":
		return DataTypeUint16Vector, nil
	case "DataTypeUint32Vector":
		return DataTypeUint32Vector, nil
	case "DataTypeUint64Vector":
		return DataTypeUint64Vector, nil
	case "DataTypeStringVector":
		return DataTypeStringVector, nil
	case "DataTypeBoolVector":
		return DataTypeBoolVector, nil
	default:
		return DataTypeUnknown, errors.New("invalid data type string: " + value)
	}
}
