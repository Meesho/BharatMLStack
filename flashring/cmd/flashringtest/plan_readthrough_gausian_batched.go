...
func planReadthroughGaussianBatched() {
	...
	flag.IntVar(&numShards, "shards", 20, "number of shards")
	flag.IntVar(&keysPerShard, "keys-per-shard", 100_00_00, "keys per shard")
	...
	flag.IntVar(&batchWindowMicros, "batch-window-us", 50, "batch window in microseconds")
